...
class CoursesPage extends React.Component {
  ...
  // Promise Style - Being refactor to asyn await style
...
function mapDispatchToProps(dispatch) {
  return {
    // createCourse: (course) => dispatch(courseActions.createCourse(course)) // Alternatively as below
    // actions: bindActionCreators(courseActions, dispatch) // this line will add all course actions to 'actions' props
...
// then within the component we can do such:
